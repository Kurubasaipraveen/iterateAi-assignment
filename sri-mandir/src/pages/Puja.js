...
const pujaData = [
  {
    ...
    image: 'https://res.cloudinary.com/dyutmmnia/image/upload/v1721371287/utzvqzeu9uqkhusaxnwe.png',
  },
  {
    ...
    buttonText: 'PARTICIPATE',
    image: 'https://res.cloudinary.com/dyutmmnia/image/upload/v1721441439/t1tm35glybd3jhehlrvf.png',
  },
  {
    ...
    buttonText: 'PARTICIPATE',
    image: 'https://res.cloudinary.com/dyutmmnia/image/upload/v1721441448/rejv6rxpcsxxaevwikdy.png',
  },
...
const PujaCards = () => {
  return (
    <div className='container'>
        <h1 className='head'>Perform your Puja as per Vedic rituals at Famous Hindu Temples in India with Sri Mandir</h1>
        <div className='second'>
        <h1>Upcoming Pujas on Sri Mandir.</h1>
        <h3>Book online puja with Sri Mandir in more than 500+ temples across India. Receive video of the puja along with the Prasad and<br/>receive blessings from the divine for prosperity and well-being of you and your family</h3>
        </div>
