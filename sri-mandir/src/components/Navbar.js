    ...
    <header className="navbar">
      <div className="navbar-content">
        ...
        <nav className="navbar-nav">
          ...
          <Link to="/puja" className="nav-link"><strong>Puja</strong></Link>
          <Link to="/panchang" className="nav-link"><strong>Panchang</strong></Link>
          <Link to="/temples" className="nav-link"><strong>Temples</strong></Link>
          <Link to="/library" className="nav-link"><strong>Library</strong></Link>
        </nav>
