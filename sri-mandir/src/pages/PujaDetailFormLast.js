  ...
  return (
    <div style={containerStyle}>
      <form onSubmit={handleFinalSubmit} style={formStyle}>
        <h4><span style={span}>&#8678;</span>Customer Details</h4>
        ...
        <p>Your Puja booking updates like Puja Photos, Videos, and other details will be sent on WhatsApp on the above number.</p>
        <label style={labelStyle}>
      ...
      <div style={boxModelStyle}>
        <h4>Puja Details</h4>
        <p><strong>Package:</strong> Partner Puja</p>
        <p><strong>₹ 1251</strong></p>
        <p><strong>Temple Venue:</strong> Maa Bagalamukhi Temple, Haridwar, Uttarakhand</p>
        <p><strong>Puja Date:</strong> 21 July, Sunday, Ashadha Shukla Chaturdashi</p>
        <p>Mahavidya Purnima Special Maa Bagalamukhi Tantra Yukta Havan for Victory in Court Cases and Victory over Enemies</p>
      </div>
    </div>
  );
};
