    ...
    <div className="puja-container">
      <div className="puja-header">
        ...
        <div className="puja-details">
          ...
          <p> 📍temple venue Shanidev Temple, Shani Shingnapur, Maharashtra pooja date<br/> 📅 20 July, Saturday, Ashadha Shukla Chaturdashi</p>
          <p><strong>Date:</strong> 20th July, 2024</p>
      ...
      <div className="section-content">
        <div id="about" className="card">
          <h3>About Puja</h3>
          <p>Saturday Shani Shingnapur Special Shani Saade Saati Peeda Shanti Mahapuja and Til Tel Abhishek for Prevention of Misfortunes and Adversities</p>
          <p>The Shani Shingnapur Temple in Maharashtra is considered the world's biggest Shani temple...</p>
        ...
        <div id="templedetail" className="card">
          ...
          <p>The Shree Shanidev Temple is located in Shani Shingnapur, Maharashtra...</p>
          <p><strong>Address:</strong> Shani Shingnapur, Maharashtra, India</p>
          <p><strong>Contact:</strong> [Temple contact information]</p>
        </div>
        ...
        <div id="completepuja" className="card">
          <h3>Complete Puja</h3>
          <p>The complete puja includes all necessary rituals and ceremonies performed by experienced priests...</p>
        </div>
        <div id="faqs" className="card">
          <h3>FAQs</h3>
          <p><strong>Q: What is Shani Saade Saati?</strong></p>
          <p>A: Shani Saade Saati is a period of seven and a half years during which the planet Shani (Saturn) is believed to influence an individual's life...</p>
          <p><strong>Q: How can I participate in the puja?</strong></p>
          <p>A: You can participate by selecting a puja package and following the instructions provided by Sri Mandir.</p>
          <p><strong>Q: What should I bring for the puja?</strong></p>
          <p>A: Specific items may vary based on the package chosen. Generally, offerings of Til Tel and other materials are required.</p>
        </div>
        {showReview && (
          <div id="review" className="form-container">
            <h3>Register for Puja</h3>
            <p>To participate in the puja, please fill out the form below with your details. We will get in touch with you on WhatsApp.</p>
